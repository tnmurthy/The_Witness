-- =============================================================================
-- The Witness — Complete Database Schema (All Migrations 001-021)
-- 
-- INSTRUCTIONS:
...
-- 4. Click RUN
--
-- This is safe to run on a fresh project. It creates everything from scratch.
-- If you get "already exists" errors, the schema is already applied — that's OK.
-- =============================================================================


-- ============================================================
-- MIGRATION: 001_extensions_and_conventions.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 002_identity_and_access.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 003_publications.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 004_issue_builder.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 005_ai_workspace.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 006_wisdom_engine.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 007_knowledge_graph.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 010_publishing_pipeline.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 011_grants_and_realtime.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 013_rbac_and_audit.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 014_publication_management.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 015_fix_is_platform_editorial.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 016_issue_builder_collaboration.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 017_ai_workspace_functions.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 018_wisdom_engine_sources.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 019_knowledge_graph_expansion.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 020_knowledge_graph_integration.sql
-- ============================================================
-- =============================================================================
...
-- ============================================================
-- MIGRATION: 021_fix_rls_anon_access.sql
-- ============================================================
-- =============================================================================
...
insert into public._witness_migrations (filename) values ('001_extensions_and_conventions.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('002_identity_and_access.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('003_publications.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('004_issue_builder.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('005_ai_workspace.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('006_wisdom_engine.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('007_knowledge_graph.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('008_search.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('009_analytics.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('010_publishing_pipeline.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('011_grants_and_realtime.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('012_seed_data.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('013_rbac_and_audit.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('014_publication_management.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('015_fix_is_platform_editorial.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('016_issue_builder_collaboration.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('017_ai_workspace_functions.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('018_wisdom_engine_sources.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('019_knowledge_graph_expansion.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('020_knowledge_graph_integration.sql') on conflict do nothing;
insert into public._witness_migrations (filename) values ('021_fix_rls_anon_access.sql') on conflict do nothing;