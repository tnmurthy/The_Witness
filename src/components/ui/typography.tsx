...
const H1 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn("font-voice text-4xl font-semibold tracking-tight text-foreground", className)}
      {...props}
    />
  )
);
...
const H2 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h2
      ref={ref}
      className={cn("font-voice text-3xl font-semibold tracking-tight text-foreground", className)}
      {...props}
    />
  )
);
...
const Eyebrow = React.forwardRef<HTMLSpanElement, React.HTMLAttributes<HTMLSpanElement>>(
  ({ className, ...props }, ref) => (
    <span
      ref={ref}
      className={cn("text-xs font-semibold uppercase tracking-wide text-gold-700", className)}
      {...props}
    />
  )
);
...
const InlineCode = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ({ className, ...props }, ref) => (
    <code
      ref={ref}
      className={cn("rounded bg-surface-2 px-1.5 py-0.5 font-mono text-sm", className)}
      {...props}
    />
  )
);
